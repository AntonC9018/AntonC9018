...
My name is Anton Curmanschii, I'm an intelligent and competent programmer, CS undergraduate.
I have programmed almost every day for the past 4 years, either in my free time, or at university.
...
Lately, I've been making a game in Unity, while developing a GPRC game server for it on ASP.NET Core, and maintaining a custom CLI tool for managing the complexity of the project.
...
I'm currently working on a Unity board game, with an ASP.NET Core GRPC game server and an ASP.NET Core web application for player statistics.
I'm doing this game mostly for learning purposes, but also to try out and accumulate some useful tools and libraries to use in later projects, it's not about getting revenue.

[![Kari](https://github-readme-stats.vercel.app/api/pin/?username=AntonC9018&repo=Zayats&show_icons=true&theme=dark)](https://github.com/AntonC9018/Zayats)
...
There are many more projects, including visualizations, game and web dev, and just random experiments, as well as most of the university assignments, where I had to make graphical visualizations, implement various algorithms and data structures, implement GUI's, configure databases and write queries, or just explain various computer science topics.
